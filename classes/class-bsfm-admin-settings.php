	...
	*/	 
	...
	static public function save()
	{
		...
		if ( isset( $_POST['bsf-mautic-nonce-edd'] ) && wp_verify_nonce( $_POST['bsf-mautic-nonce-edd'], 'bsfmauticedd' ) ) {
			...
			$bsfm['bsfm_edd_prod_slug'] = $bsfm['bsfm_edd_prod_cat'] = $bsfm['bsfm_edd_prod_tag'] = $bsfm['bsfm_config_subscribe_optin'] = false ;
			...
			if( isset( $_POST['bsfm_config_subscribe_optin'] ) ) {	$bsfm['bsfm_config_subscribe_optin'] = true;	}
