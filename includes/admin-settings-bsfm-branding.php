	...
	<form id="bsfm-branding-form" action="<?php BSFMauticAdminSettings::render_form_action( 'bsfm-branding' ); ?>" method="post">
		...
		<div class="bsfm-settings-form-content">
			...
			<div class="bsfm-branding-fields">
				...
				<input type="text" name="bsfm-knowledge-base-url" placeholder="https://www.brainstormforce.com/docs/" value="<?php echo $bsfm_knowledge_base_url; ?>" class="regular-text bsfm-knowledge-base-url" />
			</div>
